...
import { bookProps, sourceProps } from '@/type/book';
...
export const NoticeList = () => {
  const [state, setState] = useState({
    newList: [
      { id: 0, title: '编辑部联系方式' },
      { id: 1, title: '关于冒充安夏书院编辑收稿说明' },
      { id: 2, title: '安夏书院最新作者福利' },
      { id: 3, title: '权势滔天，却拿她没有办法' },
      { id: 4, title: '领钱了！2021个税汇算清缴' },
      { id: 5, title: '领钱了！2021个税汇算清缴' },
    ] as newsProps[], //新闻公告列表
    vaneList: [
      {
        id: 1,
      ...
      },
      {
        ...
        abstract: '故事不仅是一种艺术创作方式，更是一种异于逻辑的思维模式。',
        comment: 0,
        support: false,
        vip: false,
        source: null,
    ...
    authorRecommend: [
      ...
      { id: 2, name: '读点小故事', tag: '玄幻' },
      { id: 3, name: '读点小故事', tag: '玄幻' },
      { id: 4, name: '读点小故事', tag: '玄幻' },
      { id: 5, name: '读点小故事', tag: '玄幻' },
    ] as Partial<authorProps>[], //作者推荐
    topicList: [
      { id: 0, title: '有没有很爽打脸的小说？' },
      { id: 1, title: '有没有很爽打脸的小说？' },
      { id: 2, title: '有没有很爽打脸的小说？' },
      { id: 3, title: '有没有很爽打脸的小说？' },
      { id: 4, title: '有没有很爽打脸的小说？' },
      { id: 5, title: '有没有很爽打脸的小说？' },
      { id: 6, title: '有没有很爽打脸的小说？' },
      { id: 7, title: '有没有很爽打脸的小说？' },
      { id: 8, title: '有没有很爽打脸的小说？' },
      { id: 9, title: '有没有很爽打脸的小说？' },
    ] as Partial<sourceProps>[], //话题
    currenVaneIndex: 0, //当前风向标所指索引
  });
    ...
    <div style={{ marginLeft: '17px' }}>
            ...
            return (
              ...
              >
                ...
                <div className={'vane_book'}>
                  ...
                  <UseNode rIf={state.currenVaneIndex === index}>
                    <div className={'flex vane_book_details'}>
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        <p className={'font_12 vane_book_abstract'}>
                          {vane.abstract}
                        </p>
                      </div>
                    </div>
      ...
      <NoticeBox title={'作者推荐'} Icon={<AuthorIcon />}>
        <div className={'author'}>
          {state.authorRecommend.map((author, index) => {
            return (
              <div className={'author_item'} key={index}>
                ...
                <p className={'author_item_tag'}>{author.tag}</p>
              </div>
            );
          })}
        </div>
